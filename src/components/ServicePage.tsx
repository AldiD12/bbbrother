...
const trustBadges = [
  { label: "Ltd Company", detail: "Companies House #16950486" },
  { label: "£10M Insurance", detail: "Public liability cover" },
  { label: "Checkatrade 10/10", detail: "Verified reviews" },
  { label: "2-Year Guarantee", detail: "Workmanship guaranteed" },
];
...
export function ServicePage({
  ...
  return (
    <>
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                ...
                aria-label={`Get a free quote for ${serviceType.toLowerCase()}`}
              >
                Get a Free Quote
      ...
      <section className="px-6 mb-20 md:mb-28">
        <div className="max-w-7xl mx-auto">
          <div className={`grid grid-cols-1 md:grid-cols-${galleryColumns} gap-4`}>
            {galleryImages.map((img, i) => (
              <div key={i} className="rounded-lg overflow-hidden">
                <Image
                  src={img.src}
                  alt={img.alt}
                  width={galleryColumns === 2 ? 700 : 600}
                  height={galleryColumns === 2 ? 467 : 400}

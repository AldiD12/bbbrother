...
export function QuoteForm() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      setError("Could not send your enquiry. Please call us on 07475 268 206 or try again.");
      setSubmitting(false);
    }
  }
    ...
    return (
      <div className="bg-white border border-outline-variant/20 rounded-lg p-8 md:p-10 shadow-sm text-center">
        ...
        <p className="text-base text-charcoal leading-relaxed">
          ...
          <a href="tel:07475268206" className="text-secondary font-bold">
            07475 268 206
          </a>
          .
        </p>
      ...
      {step === 3 && (
        <div>
          ...
          <p className="text-base text-muted mb-6">
            You can also send us photos via WhatsApp at 07475 268 206.
          </p>
          <textarea

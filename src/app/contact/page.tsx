        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-surface-container-low rounded-lg p-6 space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-charcoal">Companies House registered #16950486</span>
              </div>
              <div className="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#b87333" strokeWidth="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                <span className="text-sm text-charcoal">&pound;10 million public liability insurance</span>
              </div>
              <div className="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#b87333" strokeWidth="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                <span className="text-sm text-charcoal">10/10 Checkatrade rating</span>
              </div>
              <div className="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#b87333" strokeWidth="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                <span className="text-sm text-charcoal">2-year workmanship guarantee</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            <form
              ...
              method="POST"
              className="bg-white border border-outline-variant/20 rounded-lg p-8 md:p-10 space-y-6 shadow-sm"
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  <label
                    htmlFor="name"
                    className="font-label font-bold text-sm text-primary mb-2 block"
                  >
                    Full Name *
                  </label>
                  <input
                    ...
                    name="name"
                    required
                    className="w-full border border-outline-variant/40 rounded-lg px-4 py-3 text-sm font-body text-primary placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-secondary/50 focus:border-secondary transition-colors"
              ...
              <div>
                ...
                <select
                  id="service"
                  name="service"
                  className="w-full border border-outline-variant/40 rounded-lg px-4 py-3 text-sm font-body text-primary focus:outline-none focus:ring-2 focus:ring-secondary/50 focus:border-secondary transition-colors bg-white"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full border border-outline-variant/40 rounded-lg px-4 py-3 text-sm font-body text-primary placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-secondary/50 focus:border-secondary transition-colors resize-vertical"
                  placeholder="Describe what you'd like done, approximate size, any plans or ideas you have..."
                />
              </div>

              <button
                type="submit"
                className="w-full bg-secondary text-white font-label font-bold py-4 px-8 rounded-full text-center transition-transform active:scale-95 hover:bg-secondary/90 text-lg"
              >
                Send Enquiry
              </button>

              <p className="text-xs text-muted text-center">
                We typically respond within 24 hours. Your details are never shared with third parties.
              </p>
            </form>
          </div>
        </div>

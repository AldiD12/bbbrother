...
const features = [
  {
    ...
    description:
      "Complete kitchen fitting from base units to wall cabinets, end panels, and plinths. We install kitchens from all major suppliers and ensure every door is perfectly aligned.",
  },
  {
    title: "Plumbing & Electrical",
    description:
      "Sink plumbing, dishwasher connections, waste runs, and all electrical work for ovens, hobs, extractors, and lighting. Everything routed cleanly and tested before sign-off.",
  },
  {
    title: "Tiling & Splashbacks",
    description:
      "From classic metro tiles to large-format porcelain and statement splashbacks. Precision cutting, level lines, and immaculate grouting that elevates the entire room.",
  },
  {
    title: "Worktops & Island Units",
    description:
      "We template, supply, and fit worktops in quartz, granite, marble, and laminate. Kitchen islands built and installed with integrated storage, seating, and power outlets.",
  },
];
...
const processSteps = [
  ...
  {
    step: "03",
    title: "Project Management from Strip-Out to Finish",
    description:
...
const galleryImages = [
  {
    ...
    alt: "Kitchen island with cabinets and marble flooring by BBBrotherBuilding",
  },
  {
    src: "/images/interior_kitchen_sink_gold_tap_marble.jpeg",
    alt: "Kitchen sink with gold tap and marble worktop in Hertfordshire",
  },
  {
    src: "/images/interior_kitchen_hob_extractor_tiling_backsplash.jpeg",
    alt: "Kitchen hob, extractor and tiling backsplash fitted by BBBrotherBuilding",
  },
];
        ...
        <div className="max-w-7xl mx-auto md:grid md:grid-cols-2 md:gap-12 md:items-center">
          <div>
            ...
            <p className="text-lg text-charcoal mb-8 leading-relaxed max-w-lg">
              Full kitchen fitting including plumbing, electrics, tiling, and
              worktop installation. From design consultation to the final reveal.
            </p>
          ...
          <div className="mt-10 md:mt-0">
            <Image
              ...
              alt="Completed kitchen fitting with grey cabinets by BBBrotherBuilding in Hertfordshire"
              width={800}
              height={600}
      ...
      <section className="px-6 mb-20 md:mb-28">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-charcoal mb-12 max-w-2xl mx-auto leading-relaxed">
            A new kitchen is the heart of any home renovation. We handle every
            trade — carpentry, plumbing, electrics, tiling — so your kitchen is
            fitted to perfection by one dedicated team.
          </p>
      ...
      <section className="relative bg-primary py-20 md:py-28 mx-6 mb-20 md:mb-28 rounded-lg overflow-hidden">
        <div className="relative z-10 text-center px-6">
          ...
          <p className="text-white/80 text-lg font-body mb-10 max-w-md mx-auto">
            Get a free site survey and fixed-price quotation for your kitchen
            fitting. No obligation, no hidden costs.
          </p>

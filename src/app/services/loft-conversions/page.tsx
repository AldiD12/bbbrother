...
const galleryImages = [
  {
    ...
    alt: "Plastered living room with skylight installed by BBBrotherBuilding",
  },
  {
    src: "/images/interior_skylight_lighting_effect.jpeg",
    alt: "Natural light streaming through skylight in loft conversion",
  },
  {
    src: "/images/interior_skylight_detail_view.jpeg",
    alt: "Skylight detail view in completed loft conversion in Hertfordshire",
  },
];
        ...
        <div className="max-w-7xl mx-auto md:grid md:grid-cols-2 md:gap-12 md:items-center">
          <div>
            ...
            <p className="text-lg text-charcoal mb-8 leading-relaxed max-w-lg">
              Dormer, hip-to-gable, and mansard loft conversions. Maximise your
              home&apos;s potential with a beautifully finished additional floor.
            </p>
          ...
          <div className="mt-10 md:mt-0">
            <Image
              ...
              alt="Skylight installation in loft conversion by BBBrotherBuilding in Hertfordshire"
              width={800}
              height={600}
      ...
      <section className="px-6 mb-20 md:mb-28">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-charcoal mb-12 max-w-2xl mx-auto leading-relaxed">
            From initial structural assessment to the final coat of paint, we handle
            every aspect of your loft conversion with precision and care.
          </p>
      ...
      <section className="relative bg-primary py-20 md:py-28 mx-6 mb-20 md:mb-28 rounded-lg overflow-hidden">
        <div className="relative z-10 text-center px-6">
          ...
          <p className="text-white/80 text-lg font-body mb-10 max-w-md mx-auto">
            Get a free site survey and fixed-price quotation for your loft
            conversion. No obligation, no hidden costs.
          </p>

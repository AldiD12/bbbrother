...
const features = [
  {
    ...
    description:
      "From layout planning to final styling, we redesign your bathroom from the ground up. New layouts, repositioned plumbing, and a cohesive design that transforms the space entirely.",
  },
  {
    title: "Tiling & Waterproofing",
    description:
      "Precision tiling in ceramic, porcelain, marble, or natural stone. Every shower enclosure and wet area is fully tanked and waterproofed to prevent leaks for decades to come.",
  },
  {
    title: "Plumbing & Fixtures",
    description:
      "We install all sanitaryware — basins, toilets, baths, showers, and taps. Pipework is neatly routed and pressure-tested before any walls are closed up.",
  },
  {
    title: "Underfloor Heating",
    description:
      "Warm tiles underfoot make all the difference. We install electric underfloor heating systems beneath your bathroom floor for year-round comfort and a touch of luxury.",
  },
];
...
const galleryImages = [
  {
    ...
    alt: "Completed bathroom with sink, tub and tiling by BBBrotherBuilding",
  },
  {
    src: "/images/interior_bathroom_complete_tub_fixtures_marble.jpeg",
    alt: "Luxury bathroom with tub, fixtures and marble finish in Hertfordshire",
  },
  {
    src: "/images/interior_bathroom_shower_tiling_detail.jpeg",
    alt: "Shower tiling detail in bathroom renovation by BBBrotherBuilding",
  },
];
        ...
        <div className="max-w-7xl mx-auto md:grid md:grid-cols-2 md:gap-12 md:items-center">
          <div>
            ...
            <p className="text-lg text-charcoal mb-8 leading-relaxed max-w-lg">
              ...
              Tiling, plumbing, fixtures, underfloor heating — all handled by
              one team.
            </p>
          ...
          <div className="mt-10 md:mt-0">
            <Image
              ...
              alt="Completed bathroom renovation with tub, shower and tiling by BBBrotherBuilding in Hertfordshire"
              width={800}
              height={600}
      ...
      <section className="px-6 mb-20 md:mb-28">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-charcoal mb-12 max-w-2xl mx-auto leading-relaxed">
            From the first tile to the final tap, we manage every element of your
            bathroom renovation — plumbing, electrics, tiling, and finishing — so
            you get a stunning result without the stress.
          </p>
      ...
      <section className="relative bg-primary py-20 md:py-28 mx-6 mb-20 md:mb-28 rounded-lg overflow-hidden">
        <div className="relative z-10 text-center px-6">
          ...
          <p className="text-white/80 text-lg font-body mb-10 max-w-md mx-auto">
            Get a free site survey and fixed-price quotation for your bathroom

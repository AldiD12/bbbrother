...
const features = [
  {
    title: "Skimming & Finishing",
    description:
      "Flawless skim coats over existing plaster or plasterboard. We achieve a perfectly smooth, paint-ready finish every time — no ripples, no ridges.",
  },
  {
    title: "Plasterboard Installation",
    description:
      "Dot-and-dab or mechanically fixed plasterboard for new walls, ceilings, and partitions. Precise fitting with seamless joints throughout.",
  },
  {
    title: "Rendering",
    description:
      "Traditional sand and cement rendering and modern monocouche finishes for exterior walls. Weather-resistant and built to last for decades.",
  },
  {
    title: "Patch Repairs & Restoration",
    description:
      "Expert repair of cracked, blown, or damaged plaster. We restore period features and blend repairs seamlessly with existing surfaces.",
  },
];
...
const processSteps = [
  {
    ...
    title: "Consultation",
    description:
      "We visit your property to assess the plastering work required, discuss finishes, and understand your project timeline.",
  },
  {
    step: "02",
    title: "Quote",
    description:
      "You receive a clear, itemised quotation with fixed pricing. No hidden costs, no surprises. The price we quote is the price you pay.",
  },
  {
    step: "03",
    title: "Build",
    description:
      "Our skilled plasterers prepare surfaces meticulously and apply coats with precision. Dust sheets down, workspace kept tidy throughout.",
  },
  {
    step: "04",
    title: "Walkthrough",
    description:
      "We inspect every wall and ceiling together, ensuring a flawless finish. All work is backed by our 2-year workmanship guarantee.",
  },
];
...
const galleryImages = [
  {
    ...
    alt: "Plastering a large room interior by BBBrotherBuilding",
  },
  {
    src: "/images/interior_wall_plastering_finishing_room.jpeg",
    alt: "Finishing room plastering work by BBBrotherBuilding",
  },
];
        ...
        <div className="max-w-7xl mx-auto md:grid md:grid-cols-2 md:gap-12 md:items-center">
          <div>
            ...
            <h1 className="font-headline text-[2.75rem] md:text-[3.5rem] leading-[1.1] tracking-tight font-black mb-6 text-primary">
              Plastering Services in{" "}
              <span className="text-secondary italic hand-drawn-underline">
                Hertfordshire
              </span>
            </h1>
            <p className="text-lg text-charcoal mb-8 leading-relaxed max-w-lg">
              Professional plastering for new builds, extensions, and
              renovations. Smooth finishes, skimming, rendering, and
              plasterboard installation by experienced tradespeople who take
              pride in every surface.
            </p>
          ...
          <div className="mt-10 md:mt-0">
            <Image
              ...
              alt="Professional plastering finished surface by BBBrotherBuilding in Hertfordshire"
              width={800}
              height={600}
      ...
      <section className="px-6 mb-20 md:mb-28">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-charcoal mb-12 max-w-2xl mx-auto leading-relaxed">
            From fresh skim coats to full plasterboard installations, we deliver
            flawless surfaces that form the perfect canvas for your interiors.
          </p>
      ...
      <section className="relative bg-primary py-20 md:py-28 mx-6 mb-20 md:mb-28 rounded-lg overflow-hidden">
        <div className="relative z-10 text-center px-6">
          ...
          <p className="text-white/80 text-lg font-body mb-10 max-w-md mx-auto">
            Get a free site survey and fixed-price quotation for your plastering
            project. No obligation, no hidden costs.
          </p>

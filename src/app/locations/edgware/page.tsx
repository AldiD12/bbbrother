...
export default function EdgwarePage() {
  return (
    <LocationPage
      ...
      galleryImages={[
        { src: "/images/interior_kitchen_sink_gold_tap_marble.webp", alt: "Kitchen renovation with marble countertops in Edgware" },
        { src: "/images/exterior_extension_brickwork_integration.webp", alt: "Extension brickwork in Edgware" },
        { src: "/images/interior_bathroom_shower_tiling_detail.webp", alt: "Shower tiling detail in Edgware bathroom" },
      ]}
    />
  );
}
